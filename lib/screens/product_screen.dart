...
import 'package:fern_n_petals/helper/carousel2.dart';
          ...
          Stack(children: [
            ...
            Positioned(
                ...
                child: Consumer<FavouriteProvider>(
                  ...
                  return IconButton(
                      ...
                      iconSize: 12,
                      onPressed: () {
                        favouriteprovider.addtoFav(pd);
                      },
                      icon: favouriteprovider.isExist(pd)
                          ? Icon(
                              Iconsax.heart5,
                              color: Colors.red,
                              size: 15,
            ...
            Positioned(
                ...
                child: InkWell(
                  onTap: () {
                    _shareText(
                        'Checkout this product $itemname at Fern N Petals');
                  },
                  child: Container(
    ...
    return Padding(
        ...
        child: Column(
            ...
            children: <Widget>[
              ...
              SizedBox(height: 200, child: ItemList(val: 20)),
            ]));
  }
}
